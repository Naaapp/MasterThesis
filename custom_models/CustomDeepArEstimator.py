...
# Relative imports
from custom_models.CustomDeepArNetwork import CustomDeepARPredictionNetwork, CustomDeepARTrainingNetwork


class CustomDeepAREstimator(GluonEstimator):
    """
    ...
    *Note:* the code of this model is unrelated to the implementation behind
    ...
    def create_training_network(self) -> CustomDeepARTrainingNetwork:
        return CustomDeepARTrainingNetwork(
    ...
    def create_predictor(
        ...
        prediction_network = CustomDeepARPredictionNetwork(
