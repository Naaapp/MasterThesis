...
class CustomSimpleFeedForwardTrainingNetwork(CustomSimpleFeedForwardNetworkBase):
...
class CustomSimpleFeedForwardPredictionNetwork(CustomSimpleFeedForwardNetworkBase):
    @validated()
    def __init__(
