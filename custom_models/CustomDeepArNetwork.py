...
class CustomDeepARNetwork(mx.gluon.HybridBlock):
    @validated()
    def __init__(
        self,
        num_layers: int,
...
class CustomDeepARTrainingNetwork(CustomDeepARNetwork):
    def distribution(
        self,
    ...
    def hybrid_forward(
        ...
        loss = compute_custom_loss(loss,  self.alpha, distr, target)
...
class CustomDeepARPredictionNetwork(CustomDeepARNetwork):
    @validated()
