...
# Relative imports
from custom_models.CustomCanonicalNetwork import CustomCanonicalPredictionNetwork, CustomCanonicalTrainingNetwork


class CustomCanonicalEstimator(GluonEstimator):
    @validated()
    def __init__(
        self,
        model: HybridBlock,
    ...
    def create_training_network(self) -> CustomCanonicalTrainingNetwork:
        return CustomCanonicalTrainingNetwork(
    ...
    def create_predictor(
        ...
        trained_network: CustomCanonicalTrainingNetwork,
    ) -> Predictor:
        prediction_net = CustomCanonicalPredictionNetwork(
...
class CustomCanonicalRNNEstimator(CustomCanonicalEstimator):
    @validated()
    def __init__(
        self,
        freq: str,
        ...
        super(CustomCanonicalRNNEstimator, self).__init__(
            model=model,
            is_sequential=True,
            freq=freq,
            ...
            distr_output_type=distr_output_type,
            alpha=alpha
        )


class MLPForecasterEstimator(CustomCanonicalEstimator):
    @validated()
    def __init__(
        self,
        freq: str,
